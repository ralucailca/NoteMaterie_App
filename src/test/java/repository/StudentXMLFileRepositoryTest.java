...
public class StudentXMLFileRepositoryTest extends TestCase {
    ...
    private StudentXMLFileRepository studentFileRepository=new StudentXMLFileRepository(validatorStudent,
            ApplicationContext.getPROPERTIES().getProperty("data.testStudRepoXML"));
    ...
    public void testDelete() {
        ...
        StudentXMLFileRepository studentFileRepository1=new StudentXMLFileRepository(validatorStudent,
                ApplicationContext.getPROPERTIES().getProperty("data.testStudRepoXML"));
